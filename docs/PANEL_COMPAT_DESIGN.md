...
> 2026-08-22 当前代码基线，src/ 目录存在多个 .bak 历史版本，代码迭代后行号可能
> 漂移——每条证据均附宏名 / 符号名，漂移时以符号搜索为准（如全局搜 `SB_QUOTE_X0`）。
...
| 2.7" 三色（型号未标） | 176x264 | BWR | 预计 24P | IL91874（GDEW027C44 同族） | GxEPD2_270c | 🔨 未测 | SMALL (264x176, 16px CJK) | 23+12KB ≈35KB |
...
|:-----|:------------------------|:-------|:-----|
| LAYOUT_SMALL | <200 px | 2.7" (264x176) | 单列、16px CJK（level 0） |
| LAYOUT_MID | 200~319 px | 3.7" (416x240)、4.2" (400x300) | 现有学习页双栏同族 |
...
| v1.4 座子兼容性 / 新屏 FPC / 420c·270c 命中率 | 统一「待上机确认」标注 + probe 兑底路径 |
...
| 2.9" | GDEH029A1/DEPG0290 | GDEW029Z10 | GDEY029F51H（busy 50s） | |
