 ...
 * 横向钳制（2026-09-19，3.1" 320 宽适配）：档位表值只管垂直约束，
 * 最宽行（行 0 十键 = 10×36+9×3 = 387px）放不下时 layout_profile
 * 按运行期 gfx 宽度下调 kb_scale（320 宽 → 80，行 0 实宽 298 ≤ 312），
 * 否则本 UI 的 (SCR_W - total)/2 居中会变负 x、左侧键被裁到屏外。
